---
name: git-worktrees
description: Creates git worktrees for parallel development. Use when creating worktrees, setting up multiple working directories, or working on features in parallel.
---
